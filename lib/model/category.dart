  ...
  static List<Category> getCategoryList(bool isDark) {
    return [
      ...
      Category(
        id: 'business',
        title: 'Business',
        image: isDark ? AppAssets.businessLight : AppAssets.businessDark,
      ),
      Category(
        id: 'sports',
        title: 'Sports',
        image: isDark ? AppAssets.sportLight : AppAssets.sportDark,
      ),
      Category(
        id: 'entertainment',
        title: 'Entertainment',
      ...
      Category(
        id: 'health',
        title: 'Health',
        image: isDark ? AppAssets.healthLight : AppAssets.healthDark,
      ),
      Category(
        id: 'science',
        title: 'Science',
